...
funcao_home_sexo_cor <- function(municipio) {
  ...
  home_sexo_cor_agrup <- ggplot(home_sexo_cor, aes(fill = Cor, y = ValuePer, x = Sexo)) +
    ...
    labs(x = "Sexo",y = "Percentual (%)", fill = "Cor/Raça: ", caption = "Fonte: Microdados da PNAD Covid-19 - IBGE. Setembro, 2020.",
         title = paste0("Pessoas em home office, por cor/raça e sexo - Salvador")) +
    scale_fill_manual(values = c("#00b894","#ff7675","#0984e3","#6c5ce7")) +
    scale_y_continuous(labels = percent_format(), limits=c(0,1)) 
  
  
  ggsave(plot = home_sexo_cor_agrup, paste0("home_sexo_cor_agrup_",municipio,".png"),
         width = 10, height = 5, dpi = 120, units = "in",type = "cairo")
  
  write.csv2(home_sexo_cor,paste0("home_sexo_cor_",municipio,".csv"), row.names = F)
...
funcao_home_edu_cor <- function(municipio) {
  ...
  home_edu_cor_agrup <- ggplot(home_edu_cor, aes(fill = Escolaridade, y = ValuePer, x = Cor)) +
    ...
    labs(x = "Cor/Raça",y = "Percentual (%)", fill = "Escolaridade: ", caption = "Fonte: Microdados da PNAD Covid-19 - IBGE. Setembro, 2020.",
         title = paste0("Pessoas em home office, por cor/raça e escolaridade - Salvador")) +
    scale_fill_manual(values = c("#00b894","#ff7675","#0984e3","#6c5ce7","#fdcb6e")) +
    scale_y_continuous(labels = percent_format(), limits=c(0,1)) +
    guides(fill = guide_legend(ncol=3,nrow=2))
  
  # Salvando em PNG
  ggsave(plot = home_edu_cor_agrup, paste0("home_edu_cor_agrup_",municipio,".png"),
         width = 10, height = 5, dpi = 120, units = "in",type = "cairo")
  
  write.csv2(home_edu_cor,paste0("home_edu_cor_",municipio,".csv"), row.names = F)
...
funcao_home_sexo_idade <- function(municipio) {
  ...
  home_sexo_idade_agrup <- ggplot(home_sexo_idade, aes(fill = Idade, y = ValuePer, x = Sexo)) +
    ...
    theme(axis.title.x = element_text(colour = "black"),
          ...
          plot.title = element_text(colour = "black", size = 17, hjust=0.5),
          legend.position = "bottom", legend.background = element_rect(fill="ghostwhite", size=0.7, linetype="blank")) +
    labs(x = "Sexo", fill = "Faixa Etária: ",y="Percentual (%)", caption = "Fonte: Microdados da PNAD Covid-19 - IBGE. Setembro, 2020.",
         title = paste0("Pessoas em home office, por sexo e faixa etária - Salvador")) +
    scale_fill_manual(values = c("#00b894","#ff7675","#0984e3","#6c5ce7","#fdcb6e")) +
    scale_y_continuous(labels = percent_format(), limits=c(0,1)) 
  
  
  
  ggsave(plot = home_sexo_idade_agrup, paste0("home_sexo_idade_agrup_",municipio,".png"),
         width = 10, height = 5, dpi = 120, units = "in",type = "cairo")
  
  write.csv2(home_sexo_idade,paste0("home_sexo_idade_",municipio,".csv"), row.names = F)
...
funcao_home_emprego <- function(municipio) {
  ...
  home_emprego_agrup <- ggplot(home_emprego, aes(fill = Tipo_emprego, y = ValuePer, x = Tipo_emprego)) +
    ...
    labs(x = "Tipo de Ocupação",y="Percentual (%)", caption = "Fonte: Microdados da PNAD Covid-19 - IBGE. Setembro, 2020.",
         title = paste0("Pessoas em home office, por tipo de ocupação - Salvador")) +
    scale_fill_manual(values = c("#00b894","#ff7675","#0984e3","#6c5ce7","#fdcb6e","#636e72", "#55efc4")) +
    scale_x_discrete(labels = legenda_trabalhos) +
    scale_y_continuous(labels = percent_format(), limits=c(0,1)) 
  
  
  ggsave(plot = home_emprego_agrup, paste0("home_emprego_agrup_",municipio,".png"),
         width = 10, height = 5, dpi = 120, units = "in",type = "cairo")
  
  write.csv2(home_emprego,paste0("home_emprego_",municipio,".csv"), row.names = F)
...
funcao_home_renda <- function(municipio) {
  ...
  home_renda_agrup <- ggplot(home_renda, aes(fill = Faixa_salario, y = ValuePer, x = Cor)) +
    ...
    theme(axis.title.x = element_text(colour = "black"),
          ...
          plot.title = element_text(colour = "black", size = 17, hjust=0.5),
          legend.position = "bottom", legend.background = element_rect(fill="ghostwhite", size=0.7, linetype="blank")) +
    labs(x = "Cor/Raça",y="Percentual (%)", fill = "Faixa Salarial:\n(Salários mínimos) ", caption = "Fonte: Microdados da PNAD Covid-19 - IBGE. Setembro, 2020.",
         title = paste0("Pessoas em home office, por cor/raça e faixa salarial - Salvador")) +
    scale_fill_manual(values = c("#fad390","#e55039","#4a69bd","#60a3bc","#78e08f","#079992")) +
    scale_y_continuous(labels = percent_format(), limits=c(0,1)) 
  
  
  
  ggsave(plot = home_renda_agrup, paste0("home_renda_agrup_",municipio,".png"),
         width = 10, height = 5, dpi = 120, units = "in",type = "cairo")
  
  write.csv2(home_renda,paste0("home_renda_",municipio,".csv"), row.names = F)
...
funcao_auxilio_renda <- function(municipio) {
  
  auxilio_renda2 <- pnad_com_pesos %>%
    filter(A002 >= 18) %>% 
    filter(CAPITAL == format(municipio)) %>% 
    group_by(Faixa_salario, auxilio_emergencial) %>%
    summarise(
      auxilio = survey_total(vartype = "ci")) 
  
  # filtrando só quem recebeu auxilio
  auxilio_renda2 <- auxilio_renda2 %>% filter(auxilio_emergencial == "Auxílio")
  
  # convertendo coluna em caracter
  auxilio_renda2$Faixa_salario <- as.character(auxilio_renda2$Faixa_salario)
  
  # transformando NA em zero
  auxilio_renda2$Faixa_salario[is.na(auxilio_renda2$Faixa_salario)] <- 0
  
  # transformando Zero em nome
  auxilio_renda2$Faixa_salario[auxilio_renda2$Faixa_salario == 0] <- 'Sem renda/Não declarada'
  
  # selecionando colunas de interesse
  auxilio_renda2 <- auxilio_renda2 %>% select(Faixa_salario, auxilio)
  
  # convetendo coluna em factor novamente
  auxilio_renda2$Faixa_salario <- as.factor(auxilio_renda2$Faixa_salario)
  
  # coluna total
  auxilio_renda2 <- auxilio_renda2 %>% mutate(total = sum(auxilio_renda2$auxilio))
  
  # porcentagem
  auxilio_renda2 <- auxilio_renda2 %>% mutate(pessoas_auxilio = (auxilio/total)*100)
  
  auxilio_renda2$Faixa_salario <- factor(auxilio_renda2$Faixa_salario, levels=c("Sem renda/Não declarada",
  ...
  # gráfico
  auxilio_renda_agrup <- ggplot(auxilio_renda2, aes(fill = Faixa_salario, y = pessoas_auxilio, x = Faixa_salario)) +
    geom_bar(position = "dodge", stat = "identity") +
    ...
    theme(axis.title.x = element_text(colour = "black"),
          ...
          plot.title = element_text(colour = "black", size = 17, hjust=0.5),
          legend.position = "none") +
    labs(x = "Faixa Salarial", y="Percentual (%)", caption = "Fonte: Microdados da PNAD Covid-19 - IBGE. Setembro, 2020.",
         title = paste0("Pessoas que receberam auxílio emergencial, por renda - Salvador")) +
    scale_fill_manual(values = c("#3c6382","#00b894","#ff7675","#0984e3","#6c5ce7","#fdcb6e","#636e72")) +
    scale_y_continuous(breaks = c(0,20,40,60,80,100),
                       labels = c("0","20","40","60","80","100"), limits = c(0,100)) 
  
  
  ggsave(plot = auxilio_renda_agrup, paste0("auxilio_renda_agrup_",municipio,".png"),
         width = 10, height = 5, dpi = 120, units = "in",type = "cairo")
  
  write.csv2(auxilio_renda2,paste0("auxilio_renda_",municipio,".csv"), row.names = F)
...
funcao_auxilio_cor_sexo <- function(municipio) {
  ...
  auxilio_cor_sexo_agrup <- ggplot(auxilio_cor_sexo, aes(fill = Cor, y = ValuePer, x = Sexo)) +
    ...
    theme(axis.title.x = element_text(colour = "black"),
          ...
          plot.title = element_text(colour = "black", size = 17, hjust=0.5),
          legend.position = "bottom", legend.background = element_rect(fill="ghostwhite", size=0.7, linetype="blank")) +
    labs(fill = "Cor: ", x = "Sexo",y="Percentual (%)",caption = "Fonte: Microdados da PNAD Covid-19 - IBGE. Setembro, 2020.",
         title = paste0("Pessoas que receberam auxílio emergencial, por cor/raça e sexo - Salvador ")) +
    scale_fill_manual(values = c("#00b894","#ff7675","#0984e3")) +
    scale_y_continuous(labels = percent_format(), limits=c(0,1)) 
  
  
  ggsave(plot = auxilio_cor_sexo_agrup, paste0("auxilio_cor_sexo_agrup_",municipio,".png"),
         width = 10, height = 5, dpi = 120, units = "in",type = "cairo")
  
  write.csv2(auxilio_cor_sexo,paste0("auxilio_cor_sexo_",municipio,".csv"), row.names = F)
  
}

funcao_auxilio_cor_sexo("29")
funcao_auxilio_renda("29")
funcao_home_edu_cor(29)
funcao_home_emprego("29")
funcao_home_renda("29")
funcao_home_sexo_cor("29")
funcao_home_sexo_idade("29")
